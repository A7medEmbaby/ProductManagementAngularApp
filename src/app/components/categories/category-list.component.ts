      ...
      <div *ngIf="!loading" class="categories-content">
        ...
        <div class="table-container slide-in">
                ...
                <td mat-cell *matCellDef="let category" class="name-cell">
                  <div class="category-name">
                    ...
                    <div class="category-info">
                      ...
                      <span class="category-id">ID: {{ category.id.substring(0, 8) }}...</span>
                    </div>
                  </div>
                </td>
              </ng-container>
              ...
              <ng-container matColumnDef="createdAt">
                ...
                <td mat-cell *matCellDef="let category">
                  <div class="date-display">
                    <span class="date-value">{{ category.createdAt | date:'MMM dd, yyyy' }}</span>
                    <span class="time-value">{{ category.createdAt | date:'HH:mm' }}</span>
                  </div>
                </td>
              </ng-container>
          ...
          <div *ngIf="dataSource.filteredData.length === 0" class="empty-state">
            ...
            <p>{{ searchInput.value ? 'No categories match your search criteria.' : 'Start by adding your first category.' }}</p>
            <button 
              mat-raised-button 
              color="primary" 
              (click)="createCategory()"
        ...
        <div class="summary-container">
          <div class="summary-info">
            <span class="result-count">
              Showing {{ getDisplayCount() }} of {{ getTotalCount() }} categories
            </span>
          </div>
        </div>
      </div>
