      ...
      <div class="page-header fade-in">
        <div class="header-content">
          <div class="title-section">
            ...
            <p class="page-subtitle">Manage your product inventory efficiently</p>
          </div>
      ...
      <div *ngIf="!loading" class="products-content">
        ...
        <div class="table-container slide-in">
              ...
              <ng-container matColumnDef="createdAt">
                ...
                <td mat-cell *matCellDef="let product">
                  <div class="date-display">
                    <span class="date-value">{{ product.createdAt | date:'MMM dd, yyyy' }}</span>
                    <span class="time-value">{{ product.createdAt | date:'HH:mm' }}</span>
                  </div>
                </td>
              </ng-container>
          ...
          <div *ngIf="dataSource.filteredData.length === 0" class="empty-state">
            ...
            <p>{{ searchInput.value ? 'No products match your search criteria.' : 'Start by adding your first product.' }}</p>
            <button 
              mat-raised-button 
              color="primary" 
              (click)="createProduct()"
        ...
        <div class="pagination-container">
          ...
          <div class="pagination-info">
            <span class="result-count">
              Showing {{ getStartIndex() }}-{{ getEndIndex() }} of {{ pagedResult?.totalCount || 0 }} products
            </span>
          </div>
        </div>
      </div>
...
export class ProductListComponent implements OnInit {
  ...
  getStartIndex(): number {
    return Math.min((this.pageNumber - 1) * this.pageSize + 1, this.pagedResult?.totalCount || 0);
  }

  getEndIndex(): number {
    return Math.min(this.pageNumber * this.pageSize, this.pagedResult?.totalCount || 0);
  }
